...
<div>
  <p class="text-sm font-oswald text-Beige-150  z-40 text-center underline mt-6">24-27 juin 2022,Besançon</p>
...
<img class="relative -top-[28rem]  xl:-mt-32 w-24   md:w-40 lg:w-48 xl:w-72   left-52" src="/images/Vector6.png" alt="image d'acceuil">
   ...
   <p class="relative    lg:-top-[700px] -top-52 text-right md:text-4xl lg:text-5xl xl:text-7xl 2xl:text-9xl   text-3xl text-Beige-150 font-oswald">VENEZ VIVRE LE </p>
  
   <p class="relative    lg:-top-[700px] -top-52 text-right   md:text-4xl lg:text-5xl xl:text-7xl 2xl:text-9xl text-3xl text-Beige-150 font-oswald">ROCK</p>
...
//logo Menu Hamburger 
import MenuHamburger from "../components/icons/HamburgerMenue.vue"




//logo festival 
import logofestival from '../components/icons/logofestival.vue';

//logo reseau sociaux 
import LogoFacebook from '../components/icons/Facebook.vue';
import LogoTwitter from '../components/icons/Twitter.vue';
...
import HamburgerMenue from "../components/icons/HamburgerMenue.vue";
